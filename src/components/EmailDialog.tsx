        ...
        <div>
            <Dialog onClose={close} aria-labelledby="customized-dialog-title" open={open}>
                ...
                <DialogContent sx={{ p: 2, margin: '10px 50px 20px 0px' }}>
                    <DialogContentText>Please enter your new email address and confirm it</DialogContentText>
                    {error && <p style={{ color: 'red', fontSize: '15px', fontWeight: 'bold', marginTop: '10px' }}>{errorMessage}</p>}
                    <TextField
                        autoFocus
                        margin="dense"
                ...
                <DialogActions sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', p: 0 }}>
                    ...
                    <a onClick={changeEmail} className={styles.logout} style={{ marginLeft: 0 }}>
                        Change Email
                    </a>
                </DialogActions>
            </Dialog>
